    ...
    public partial class BanHang : UserControl
    {
        ...
        public void getData()
        {
            ...
            foreach (Product product in products)
            {
                ...
                {
                    Button button = new Button() { Width = Product.ProductWith, Height = Product.ProductHeight, BackColor = Color.White, ForeColor = Color.Black };
                    flowPro.Controls.Add(button);
                    button.Text = product.Name;


                    //button.Text = product.Price;
        ...
        private void btnThanhToan_Click(object sender, EventArgs e)
        {
            ...
            Orders.Instance.saveOrders(pEmpId, pCusId, pSum, pDiscount, pDayOrder);
            ...
            int pOrderID = OrdersDetailDAO.Instance.getOrderID(pDayOrder);
